// this one has an addressing bug, can you find it?
// this version uses .bss instead of .data
.text
.balign 4
.global main
main:
...
oa_loop:cmp r4, r1	// Is R4 equal to the number of elements to output?
	...
	add r0, r4, LSL #2 // next address is R0=R0+(R4*4)
